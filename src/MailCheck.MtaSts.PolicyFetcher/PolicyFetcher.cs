        ...
        public async Task<MtaStsPolicyResult> Process(string domain)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                catch (HttpRequestException e)
                {
                    ...
                    errors.Add(new FailedToFetch(
                        "SSL connection could not be established when attempting to fetch policy file.",
            ...
            result.Errors.AddRange(evaluationResult.AdvisoryMessages);
